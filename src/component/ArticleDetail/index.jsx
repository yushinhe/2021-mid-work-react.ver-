...
export default class index extends Component {
    constructor(props) {
        ...
        this.state = {
            data: props.Data,
            recommandData: Data.find(item => item.id == Math.ceil(Math.random() * 9)),
        };
    }
    render() {
        return (
            <>
                <div className='article-deatil'>
                    ...
                    <main>
                        ...
                        <figure class="big-pic container">
                        ...
                        <div class="content-container container">
                            <div class="famous-saying">
                                ...
                                <h4> <i class="fas fa-user-alt"></i>知名冒險家-李恆昇</h4>
                            </div>
                            <article>
                                <p>
                                ...
                                <form action="" class="message">
                                    ...
                                    <button type="submit" class="btn btn-gray">送出</button>
                                </form>
                            </article>
                            <div class="also-recommand">
                                <div class="recommand">
